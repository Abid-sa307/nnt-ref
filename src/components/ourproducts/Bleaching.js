      ...
      >
        <div className="container">
          <div className="row align-items-center">
            ...
            {/* Right - Image Instead of Placeholder */}
<div className="col-md-6 text-center">
  <img
    src={BleachingEarthImg} // ✅ import this image at the top
    alt="Bleaching Earth Packaging Preview"
    style={{
      height: '400px',
      width: '100%',
      objectFit: 'cover',
...
<section className="py-5 bg-white">
  <div className="container">
    <div className="row align-items-center g-4">
      ...
      <div className="col-md-6 text-center">
        <img
          src={Clinkerization} // Replace with actual product/factory image
          alt="Bleaching Earth Powder Plant"
    ...
    <div className="row g-4 align-items-center">
      ...
      <div className="col-md-6">
        <img
            ...
            alt="MSDS Sheet - Bleaching-Earth"
            className="img-fluid rounded-4 shadow"
            style={{
              maxHeight: '1000px',
              objectFit: 'contain',
