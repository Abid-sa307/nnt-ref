  ...
  return (
    <>
      ...
      <section className="py-5 bg-light">
        <Container>
          <h2 className="text-center fw-bold mb-4" style={{ color: '#3666cc', fontFamily: '"Segoe UI", "Roboto", "Helvetica", sans-serif' }}>
            ...
            <Col md={10}>
              ...
              >
                <li className="mb-4 d-flex">
                  ...
                  ></span>
                  <div>
                    <strong>Increases Nutrient Uptake Efficiency:</strong>
                    <br />
                    Citric acid binds with micronutrients like Fe, Zn, Mn and Mg to form chelates, which are more readily absorbed by plant roots.
                  </div>
                </li>
                ...
                <li className="mb-4 d-flex">
                  ...
                  ></span>
                  <div>
                    <strong>Acts as a Natural pH Regulator:</strong>
                    <br />
                    Helps maintain optimal soil pH levels for better nutrient availability, particularly in hydroponic systems and alkaline soils.
                  </div>
                </li>
                ...
                <li className="mb-4 d-flex">
                  ...
                  ></span>
                  <div>
                    <strong>Biodegradable & Eco-Friendly:</strong>
                    <br />
                    Citric acid is naturally occurring and safe for the environment—ideal for sustainable and organic farming practices.
                  </div>
                </li>
              </ul>
            </Col>
